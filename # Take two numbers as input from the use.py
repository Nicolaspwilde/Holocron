...
occurrences, total_positions, first_occurrence = find_number_in_list(
    number_list, target_number
)
if occurrences == 0:
    first_occurrence = -1
    ...
    print(
        f"{target_number} occurred {occurrences} time(s) in the list. and it took {total_positions} positions to check.with first occurrence at position {first_occurrence}."
    )
